          ...
          <ChartContainer className="w-full h-[350px]" config={chartConfig}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={data} margin={{ top: 20, right: 20, left: 0, bottom: 10 }}>
                ...
                <Bar dataKey="profit" radius={[6, 6, 0, 0]} fill={chartConfig.profit.color} barSize={18} />
                <Bar dataKey="revenue" radius={[6, 6, 0, 0]} fill={chartConfig.revenue.color} barSize={18} />
              </BarChart>
            </ResponsiveContainer>
          </ChartContainer>
        )}
