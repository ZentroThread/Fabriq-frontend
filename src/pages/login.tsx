    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-[#fff7f9] via-[#ffeef3] to-[#f7c8d2]">
      <div className="max-w-6xl w-full grid md:grid-cols-2 gap-10 items-center">
        ...
        <div className="text-center">
          ...
          <h1 className="text-4xl font-bold text-style">Hiru Sandu</h1>
          <p className="text-lg text-gray-600 -mt-1">Bridal Wear</p>
          <p className="text-sm text-gray-500 mt-1">Elegance in Every Thread</p>
          ...
          <div className="mt-6 flex justify-center">
            <img
              src={modelImg}
              alt="model"
              className="w-80 h-[420px] object-cover rounded-2xl shadow-lg border-4 border-layout-bg"
            />
        ...
        {/* LOGIN FORM */}
        <div
          className="bg-layout-bg p-10 rounded-2xl border-[1.5px] border-[#f3c4cf]"
          style={{ boxShadow: "0px 10px 35px rgba(255, 182, 193, 0.35)" }}
        >
